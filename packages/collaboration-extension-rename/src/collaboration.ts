...
import { IGlobalAwareness } from 'jupyter-collaborative-drive-rename';
import { WebSocketAwarenessProvider } from 'jupyter-docprovider-rename';
...
import {
  ...
  UserInfoPanel,
  UserMenu
} from 'jupyter-collaboration-rename';
...
export const userMenuPlugin: JupyterFrontEndPlugin<IUserMenu> = {
  id: 'jupyter-collaboration-extension-rename:userMenu',
...
export const menuBarPlugin: JupyterFrontEndPlugin<void> = {
  id: 'jupyter-collaboration-extension-rename:user-menu-bar',
...
export const rtcGlobalAwarenessPlugin: JupyterFrontEndPlugin<IAwareness> = {
  id: 'jupyter-collaboration-extension-rename:rtcGlobalAwareness',
...
export const rtcPanelPlugin: JupyterFrontEndPlugin<void> = {
  id: 'jupyter-collaboration-extension-rename:rtcPanel',
...
export const userEditorCursors: JupyterFrontEndPlugin<void> = {
  id: 'jupyter-collaboration-extension-rename:userEditorCursors',
  description:
