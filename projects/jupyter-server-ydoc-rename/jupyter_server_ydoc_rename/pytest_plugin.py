...
from jupyter_server_ydoc_rename.loaders import FileLoader
from jupyter_server_ydoc_rename.rooms import DocumentRoom
from jupyter_server_ydoc_rename.stores import SQLiteYStore
...
def jp_server_config(
    ...
    return {
        "ServerApp": {
            "jpserver_extensions": {
                "jupyter_server_ydoc_rename": True,
